                ...
                {messageList.map((msg, i) => {
                    return (
                        <ul className={msg.sender.name === user.name ? "flex flex-col items-end mb-5" : "flex flex-col items-start mb-5"} key={i}>
                            ...
                            <li className={msg.sender.name === user.name ? "flex flex-col shadow-inner shadow-slate-300 rounded-bl-3xl rounded-tr-3xl  rounded-tl-3xl p-3 m-1 mycolor" : "flex flex-col shadow-inner shadow-slate-300 rounded-br-3xl rounded-tl-3xl  rounded-tr-3xl w-fit p-3 m-1 bg-white text-black "}>
            ...
            <div className="flex absolute  bottom-0 pb-4 px-3 " style={{ width: "-webkit-fill-available" }}>
                <form onSubmit={handleSubmit} style={{ width: "-webkit-fill-available" }} action="" method='post'>
                    <div className="flex shadow-inner shadow-slate-300 justify-center rounded-2xl  bg-white  " style={{ width: "-webkit-fill-available" }}>
                        ...
                        <button type='submit' className='m-2  px-3 py-2 rounded-xl bg-teal-500 hover:opacity-70' ><i className="fa-solid fa-paper-plane text-emerald-800"></i></button>
                    </div>
